<template>
  <div class="flex items-center mt-[20px]">
    <div class="md:flex">
    <span class="text-[30px] font-semibold ">Анкеты</span>
    <span class="flex items-center md:mx-[10px] mb-[10px] md:mb-0 text-[#0D112666]">
      <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="4" cy="4" r="4" fill="#40D986"/>
</svg>1276 онлайн
    </span></div>
    <button class="ml-auto flex items-center py-[6px] px-[10px] rounded-[10px] bg-[#FF185F1A] text-[#FF185F]">Все <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
